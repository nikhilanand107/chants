    ...
    <div className="relative min-h-[80vh] flex flex-col justify-center items-center px-4 pt-10">
      ...
      <div className="relative z-10 w-full max-w-md glass-panel p-8 rounded-3xl shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-display font-bold text-white">Access Your Account</h2>
          <p className="text-slate-400 mt-2 text-sm font-sans">Enter your credentials to continue your Japa practice</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-400">
          New to the platform?{' '}
          <Link to="/register" className="text-spiritual-orange hover:text-spiritual-orange-dark transition-all font-medium">
            Register an account
          </Link>
        </div>
      </div>
